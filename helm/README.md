...
![Version: 2.23.0-1](https://img.shields.io/badge/Version-2.23.0--1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.23.0-1](https://img.shields.io/badge/AppVersion-2.23.0--1-informational?style=flat-square)
...
| manager.image.tag                     | string | `"2.23.0-1-no-s6"`                                          | Image tag (immutable tags are recommended)                                                                                 |
...
| portal.image.tag                      | string | `"2.23.0-1-no-s6-hiperf"`                                   | Image tag (immutable tags are recommended)                                                                                 |
...
| cronjob.image.tag                     | string | `"2.23.0-1-no-s6"`                                          | Image tag (immutable tags are recommended)                                                                                 |
