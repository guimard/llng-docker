    ...
    <div class="modal-content">
      ...
      <form action="<TMPL_VAR NAME="FORM_ACTION">" method="POST" id="finduserForm" role="form" class="login">
          ...
          <TMPL_LOOP NAME="FIELDS">
            <TMPL_IF NAME="select">
              <div class="input-group">
                <select class="form-select" id="findUser_<TMPL_VAR NAME="key">" name="<TMPL_VAR NAME="key">">
        ...
        <div class="modal-footer justify-content-between">
          <button id="closefinduserform" type="button" class="btn btn-secondary me-auto" data-bs-dismiss="modal"><span trspan="close">Close</span></button>
          <button id="finduserbutton" type="submit" class="btn btn-info" data-bs-dismiss="modal">
